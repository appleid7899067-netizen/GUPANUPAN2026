...
### แอป static ทั้งระบบ (served คู่กับเว็บหลัก)

โฟลเดอร์ `public/apps/` มีแอปไฟล์ล้วน 3 ตัว เสิร์ฟผ่าน rewrite ใน `next.config.ts`
โดยไม่ต้อง deploy แยก: `/apps` (โฮม 3 แกน) · `/apps/agent` · `/apps/blog`
หน้าแรกของ Studio มีปุ่ม ✳ Apps ลิงก์ไป รายละเอียดดู `public/apps/README.md`
